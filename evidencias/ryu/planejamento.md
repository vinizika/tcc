...
| 5 | **Frente prova — lote oficial (~150 casos, dev/teste)** | 🔶 em andamento, 21/09 | Lote `dev` (50 casos, 47 tópicos, 16 pares de confusão) escrito em `data/prova/casos_oficiais.csv`. Falta o lote `teste` (~100 casos) para completar e congelar por hash |
