...
| 5 | **Frente prova — lote oficial (~150 casos, dev/teste)** | 🔶 quase completo | 150 casos em `data/prova/casos_oficiais.csv`, 61/61 tópicos, 23 pares. Ferramenta de congelamento pronta (`prova_freeze.py`), mas **não executada**: o baseline de saco de palavras deu 0,912 (acima do critério de 0,90 do B-05) nos 150 casos combinados. Decisão de congelar mesmo assim, ou diversificar autoria antes, é do time |
