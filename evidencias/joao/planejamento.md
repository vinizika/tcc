...
| 6 | **Ferramentas da frente base**: mapa de assuntos, agentes de curadoria e retorno por lote | 🔄 em andamento — mapa ([rodada 11](2026-09-12-12-mapa-de-assuntos.md)) e pesquisador ([rodada 12](2026-09-12-13-pesquisador.md)) prontos; faltam a validação dos especialistas, o roteiro da ingestão e o `compare` | Deixou de ser "a decidir". Nenhuma técnica nova de prompt vale a pena antes de a base cobrir os assuntos e a prova medir triagem de verdade, então a entrega do B2 passa a ser **construir o que destrava as duas frentes**: o mapa de assuntos, os roteiros dos agentes e o `compare` da régua ([B-50](../backlog.md#b-50), [B-51](../backlog.md#b-51)). O Self-Refine e a camada determinística continuam **em stand-by**, pelo motivo da [rodada 9](2026-09-12-09-autopsia-do-cot.md#adendo-de-1209--as-três-correções-em-linguagem-simples-e-uma-hipótese-em-espera): o que o modelo escreve sobre a própria decisão é racionalização, e qualquer alternativa depende do corte, da base e da prova para ser **avaliada** sem circularidade |
