...
| 13 | 12/09 | [Compare da régua](2026-09-12-14-compare-da-regua.md) | O instrumento que a **porta de decisão** de 26/09 vai ler: quatro dos seis critérios saem dele. Achado do caminho: **a régua é determinística** — duas rodadas sobre a mesma base dão posições idênticas, então aqui diferença é sinal, não ruído. O piloto pegou um falso positivo que teria virado ruído permanente |
